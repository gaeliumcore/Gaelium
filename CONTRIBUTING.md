Contributing to Gaelium Core
============================

The Gaelium Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *GUI* for changes to gaelium-qt
  - *Mining* for changes to the mining code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST/ZMQ* for changes to the RPC, REST or ZMQ APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the gaelium unit tests or QA tests
...
The following applies to code changes to the Gaelium project (and related
projects) and is not to be confused with overall Gaelium
Network Protocol consensus changes.

Whether a pull request is merged into Gaelium rests with the project merge
...
Patches that change Gaelium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gaelium consensus, it must have been
...
The GaeliumQT-SIG selects a release manager for each Gaelium release.
