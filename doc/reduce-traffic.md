...
By default, gaelium-core allows up to 125 connections to different peers, 12 of
...
limits are tiny. Keep in mind that gaelium's trustless model works best if you are
