...
This document provides guidelines for internationalization of the Gaelium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gaelium_en.ts` remains unchanged.
