Build instructions for Gaelium 
=================================
...
You can now start gaelium-qt from the build directory.

`src/qt/gaelium-qt`

gaeliumd and gaelium-cli are in `src/`
