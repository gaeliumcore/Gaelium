Gaelium Core version *2.1.0* is now available!!
==============

  <https://github.com/gaeliumcore/Gaelium/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/gaeliumcore/Gaelium/commits/release_2.1.0>
