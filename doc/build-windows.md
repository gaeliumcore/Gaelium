...
Below are some notes on how to build Gaelium Core for Windows.
...
way. This will install to `c:\workspace\gaelium`, for example:

    make install DESTDIR=/mnt/c/workspace/gaelium
