...
We’re all in this together. There are new capabilities included in the latest Phoenix version (3.2+) of Gaelium that open up new business opportunities.  Join in and build something.  This is not an exhaustive list, but just a starting point to fire the imagination.  
...
* Core
    * Asset Exchange Proxy (simulate sending an ASSET like gaeliumd does for GAEL)
...
* Run a contest: GAEL prize for best idea for new Gaelium based Business
...
* Back-end API platform for Gaelium
    * Other people to hit high-availablity API
* Fee system to pay GAEL fees automatically
    * Auto-pay fees
    * Can take X% of fees
...
* Auto fee funder (so users of ABC token doesn’t need to worry about fees)
    ...
    * Sends small amount of GAEL for fees.
...
* #KYC tagger - store info and tag Gaelium addresses
* #ACCREDITED - verify accredited status and tag Gaelium addresses
 
### Technical Consultant
* Help companies apply Gaelium capabilities to real-world problems
* Security Token Issuance Platform
* Collaborate with exchanges for more listings
* Collaborate with custodial Security Token exchanges for deposit/withdrawal
* Collaborate with hardware wallets for additional GAEL and asset support


### Areas for Gaelium Innovation
* Financial
