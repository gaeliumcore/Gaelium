...
void ReceiveCoinsDialog::setupRequestFrame(const PlatformStyle *platformStyle)
{
    ...
    ui->frame2->setStyleSheet(".QFrame {background-color: #111827; border: 1px solid rgba(13, 181, 132, 0.1); border-radius: 12px; padding: 16px;}");
...
{
    /** Update the coincontrol frame */
    ui->frame->setStyleSheet(".QFrame {background-color: #111827; border: 1px solid rgba(13, 181, 132, 0.1); border-radius: 12px; padding: 16px;}");
    /** Create the shadow effects on the frames */
...
void ReceiveCoinsDialog::copyURI()
{
    ...
    const QString uri = GUIUtil::formatGaeliumURI(submodel->entry(sel.row()).recipient);
