...
#ifndef GAELIUM_QT_OPTIONSMODEL_H
#define GAELIUM_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Gaelium client.
...
#endif // GAELIUM_QT_OPTIONSMODEL_H
