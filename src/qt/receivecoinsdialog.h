...
#ifndef GAELIUM_QT_RECEIVECOINSDIALOG_H
#define GAELIUM_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of gaeliums */
...
#endif // GAELIUM_QT_RECEIVECOINSDIALOG_H
