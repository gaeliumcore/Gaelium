...
#ifndef GAELIUM_QT_SENDASSETSENTRY_H
#define GAELIUM_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending gaeliums.
...
#endif // GAELIUM_QT_SENDASSETSENTRY_H
