...
#include "config/gaelium-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatGaeliumURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + GaeliumUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatGaeliumURI(info));
}
