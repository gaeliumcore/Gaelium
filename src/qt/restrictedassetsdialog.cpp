...
void RestrictedAssetsDialog::setupStyling(const PlatformStyle *platformStyle)
{
    ...
    ui->frameAssetBalance->setStyleSheet(".QFrame {background-color: #111827; border: 1px solid rgba(13, 181, 132, 0.1); border-radius: 12px; padding: 16px; border: none;}");
    ui->frameAddressList->setStyleSheet(".QFrame {background-color: #111827; border: 1px solid rgba(13, 181, 132, 0.1); border-radius: 12px; padding: 16px; border: none;}");

    ui->tabFrame->setStyleSheet(".QFrame {background-color: #111827; border: 1px solid rgba(13, 181, 132, 0.1); border-radius: 12px; padding: 16px; border: none;}");
...
void RestrictedAssetsDialog::freezeAddressClicked()
{
    ...
    if(nRequiredFee > 0)
    {
        ...
        questionString.append(GaeliumUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), nRequiredFee));
