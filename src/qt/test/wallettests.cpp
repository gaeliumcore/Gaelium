...
#include "qt/gaeliumamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<GaeliumAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_gaelium-qt -platform xcb      # Linux
//     src/qt/test/test_gaelium-qt -platform windows  # Windows
//     src/qt/test/test_gaelium-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = GaeliumUnits::formatWithUnit(unit, balance, false, GaeliumUnits::separatorAlways);
    ...
    // Amount input
    GaeliumAmountField* amountInput = receiveCoinsDialog.findChild<GaeliumAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: gaelium:")) != -1);
