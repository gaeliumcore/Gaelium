...
#ifndef GAELIUM_QT_GAELIUMGUI_H
#define GAELIUM_QT_GAELIUMGUI_H
...
/**
  Gaelium GUI main class. This class represents the main window of the Gaelium UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GaeliumGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit GaeliumGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~GaeliumGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a gaelium wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
