...
#ifndef GAELIUM_QT_GAELIUMUNITS_H
#define GAELIUM_QT_GAELIUMUNITS_H
...
/** Gaelium unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GaeliumUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GaeliumUnits(QObject *parent);
...
typedef GaeliumUnits::Unit GaeliumUnit;

#endif // GAELIUM_QT_GAELIUMUNITS_H
