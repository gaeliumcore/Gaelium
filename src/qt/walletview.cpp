...
void WalletView::setGaeliumGUI(GaeliumGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? GaeliumGUI::HD44_ENABLED : _walletModel->hdEnabled() ? GaeliumGUI::HD_ENABLED : GaeliumGUI::HD_DISABLED);
