...
#ifndef GAELIUM_QT_GUIUTIL_H
#define GAELIUM_QT_GUIUTIL_H
...
/** Utility functions used by the Gaelium Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "gaelium:" URI into recipient object, return true on successful parsing
