    ...
    mapper(0)
{
    ...
    ui->gaeliumAtStartup->setToolTip(ui->gaeliumAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->gaeliumAtStartup->setText(ui->gaeliumAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openGaeliumConfButton->setToolTip(ui->openGaeliumConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new GaeliumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->gaeliumAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openGaeliumConfButton_clicked()
{
