    ...
    platformStyle(_platformStyle)
{
    ...
    // normal gaelium address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying gaelium address(es)
    ...
    this->setStyleSheet(".SendCoinsEntry {background-color: #111827; border: 1px solid rgba(13, 181, 132, 0.1); border-radius: 12px; padding: 16px;}");
