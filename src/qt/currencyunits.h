...
#ifndef GAELIUM_QT_CURRENCYUNITS_H
#define GAELIUM_QT_CURRENCYUNITS_H

#include <QString>
#include <array>

/** Currency unit definitions. Stores basic title and symbol for a gael swap asset,
...
#endif // GAELIUM_QT_CURRENCYUNITS_H
