 ...
 */
#ifndef GAELIUM_UTIL_H
#define GAELIUM_UTIL_H
...
extern const char *const GAELIUM_CONF_FILENAME;
extern const char *const GAELIUM_PID_FILENAME;
...
{
    std::string s = strprintf("gaelium-%s", name);
