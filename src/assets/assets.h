...
#ifndef GAELIUM_ASSET_PROTOCOL_H
#define GAELIUM_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_GAELIUM_ASSET GAELQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_GAELIUM_ASSET GAELO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_GAELIUM_ASSET GAELR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_GAELIUM_ASSET GAELT
...
#endif //GAELIUM_ASSET_PROTOCOL_H
