...
#ifndef GAELIUM_SCRIPT_STANDARD_H
#define GAELIUM_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_GAELIUM_ASSET script that carries data
    /** GAEL END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a gaelium address
 */
...
/**
 * Generate a Gaelium scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // GAELIUM_SCRIPT_STANDARD_H
