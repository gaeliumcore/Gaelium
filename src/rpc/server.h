...
#ifndef GAELIUM_RPCSERVER_H
#define GAELIUM_RPCSERVER_H
...
/**
 * Gaelium RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isGAEL = true);
