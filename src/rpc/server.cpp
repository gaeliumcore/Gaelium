...
CAmount AmountFromValue(const UniValue& value, bool p_isGAEL)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Gaelium server stopping";
}
...
{
    return "> gaelium-cli " + methodname + " " + args + "\n";
}
