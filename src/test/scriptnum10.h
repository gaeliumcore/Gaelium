...
#ifndef GAELIUM_TEST_SCRIPTNUM10_H
#define GAELIUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Gaelium Core 0.10.0, for cross-comparison.
 */
public:
