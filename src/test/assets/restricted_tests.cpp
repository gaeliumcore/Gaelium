...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler gael tx
        CScript gaelTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut gaelOut(1*COIN, gaelTransfer);
        ...
        mutTxTest1.vout.emplace_back(gaelOut);
        ...
        mutTxTest2.vout.emplace_back(gaelOut);
        ...
        mutTxTest3.vout.emplace_back(gaelOut);
        ...
        mutTxTest4.vout.emplace_back(gaelOut);
        ...
        mutTxTest5.vout.emplace_back(gaelOut);
        ...
        mutTxTest6.vout.emplace_back(gaelOut);
        ...
        mutTxTest7.vout.emplace_back(gaelOut);
        ...
        mutTxTest8.vout.emplace_back(gaelOut);
