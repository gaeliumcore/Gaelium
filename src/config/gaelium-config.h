/* src/config/gaelium-config.h.  Generated from gaelium-config.h.in by configure.  */
/* src/config/gaelium-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GAELIUM_CONFIG_H

#define GAELIUM_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Gaelium Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Gaelium Core"
...
#define PACKAGE_BUGREPORT "https://github.com/GaeliumProject/Gaelium/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Gaelium Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Gaelium Core 4.6.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "gaelium"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://gaelium.org/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "4.6.1.1"
