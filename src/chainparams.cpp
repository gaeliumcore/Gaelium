...
{
    const char* pszTimestamp = "2026 In an ocean of fake coins, Gaelium is native blockchain.";
    const CScript genesisOutputScript = CScript() << ParseHex("020ce130606bc8fb8cf001258d1f330bef47314e2e7599919c5181cbe77763c691") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nRuleChangeActivationThreshold = 806; // Approx 80% of 1008
        ...
        consensus.nMinimumChainWork = uint256S("0x00"); // Modified for new chain

        // By default assume that the signatures in ancestors of this block are valid. Block# 1040000
        consensus.defaultAssumeValid = uint256S("0x00"); // Disabled for fresh start
        ...
        genesis = CreateGenesisBlock(1769371951, 6891632, 0x1e00ffff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetX16RHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000019d7cd63d25139205de6e9f0b671e91df144ba1414bcc8a921aea7dc9e"));
        assert(genesis.hashMerkleRoot == uint256S("0x9280011d752efed0c25a1d8a3fbd5d9ba50b953cac65f994b9d95437c9be6cfe"));



        vSeeds.emplace_back("seed1.gaelium.io", false); // Gaelium-node1
        vSeeds.emplace_back("seed2.gaelium.io", false); // Gaelium-node2
        vSeeds.emplace_back("seed3.gaelium.io", false); // Gaelium-node3
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x01, 0x49, 0x0B, 0x01}; // Gpub...
        base58Prefixes[EXT_SECRET_KEY] = {0x01, 0x49, 0x06, 0xC7}; // Gprv...

        // Gaelium BIP44 cointype in mainnet is '175'
        nExtCoinType = 1313;
        ...
        // Gaelium: 964 transactions as of block #942
        ...
        nKAAAWWWPOWActivationTime = 1769371952; // KAWPOW activation time, just after block 2
...
public:
    CTestNetParams() {
        // Gaelium testnet is disabled - not used in production.
        // Values mirror mainnet where possible for code consistency.
        strNetworkID = "test";
        ...
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 655; // Approx 65% of 1008
        consensus.nMinerConfirmationWindow = 1008; // nPowTargetTimespan / nPowTargetSpacing
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1199145601; // January 1, 2008
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1230767999; // December 31, 2008
        ...
        // Fresh start - no Ravencoin chain work
        consensus.nMinimumChainWork = uint256S("0x00");

        // Disabled - fresh start
        ...
        // Reuse mainnet genesis block (testnet is disabled/unused)
        genesis = CreateGenesisBlock(1769371951, 6891632, 0x1e00ffff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetX16RHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000019d7cd63d25139205de6e9f0b671e91df144ba1414bcc8a921aea7dc9e"));
        assert(genesis.hashMerkleRoot == uint256S("0x9280011d752efed0c25a1d8a3fbd5d9ba50b953cac65f994b9d95437c9be6cfe"));
        ...
        // Gaelium BIP44 cointype in testnet
        nExtCoinType = 1;
        ...
        nMaxReorganizationDepth = 60; // 60 blocks at 2 min = +/- 120 minutes
        nMinReorganizationPeers = 4;
        nMinReorganizationAge = 60 * 60 * 12; // 12 hours

        nAssetActivationHeight = 435456; // Match mainnet
        nMessagingActivationBlock = 1092672; // Match mainnet
        nRestrictedActivationBlock = 1092672; // Match mainnet

        nKAAAWWWPOWActivationTime = 1769371952; // Match mainnet
        nKAWPOWActivationTime = nKAAAWWWPOWActivationTime;
        /** GAEL End **/
    }
};
...
//        /////////////////////////////////////////////////////////////////
        ...
        // Gaelium BIP44 cointype in regtest
        nExtCoinType = 1;
