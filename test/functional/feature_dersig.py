...
class BIP66Test(GaeliumTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # gaeliumd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and gaeliumd produces more specific reject
            # reasons.
