...
# TestNode: A peer we use to send messages to gaeliumd, and store responses.
...
class CompactBlocksTest(GaeliumTestFramework):
    ...
    # This test actually causes gaeliumd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that gaeliumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for gaeliumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # gaeliumd will not send blocktxn responses for blocks whose height is
