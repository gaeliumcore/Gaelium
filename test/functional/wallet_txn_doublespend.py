...
class TxnMallTest(GaeliumTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 GAEL:
        ...
        # First: use raw transaction API to send 1240 GAEL to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 GAEL coin each
        ...
        # Node0's balance should be starting balance, plus 50GAEL for another
        ...
        # Node0's total balance should be starting balance, plus 100GAEL for 
