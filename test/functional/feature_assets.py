...
class AssetTest(GaeliumTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("GAELIUM1", 1000)
        n0.issue("GAELIUM2", 1000)
        n0.issue("GAELIUM3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="GAELIUM*", verbose=False, count=2, start=-2)
        ...
        gaelium_assets = n0.listassets(asset="GAELIUM*", verbose=False, count=2, start=-2)
        assert_equal(len(gaelium_assets), 2)
        assert_equal(gaelium_assets[0], "GAELIUM2")
        assert_equal(gaelium_assets[1], "GAELIUM3")
        self.sync_all()
