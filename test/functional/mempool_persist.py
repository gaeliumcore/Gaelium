...
By default, gaeliumd will dump mempool on shutdown and
...
class MempoolPersistTest(GaeliumTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give gaeliumd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent gaeliumd from writing mempool.dat to disk. Verify that `savemempool` fails")
