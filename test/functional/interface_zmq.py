...
import os
import struct
from test_framework.test_framework import GaeliumTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(GaeliumTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that gaelium has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("gaeliumd has not been built with zmq enabled.")
