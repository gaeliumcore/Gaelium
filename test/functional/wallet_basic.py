...
class WalletTest(GaeliumTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 GAEL from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 GAEL with subtract fee from amount
        ...
        # Sendmany 10 GAEL with subtract fee from amount
