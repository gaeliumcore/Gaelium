...
class TestGaeliumCli(GaeliumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `gaelium-cli getinfo`")
        ...
        self.log.info("Compare responses from `gaelium-cli -getinfo` and the RPCs data is retrieved from.")
