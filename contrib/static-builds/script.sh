...
find ${DISTNAME}/bin -type f -executable -exec ../gaelium/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../gaelium/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/gaelium/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/gaelium/depends/SDKs/MacOSX10.11.sdk.tar.gz
