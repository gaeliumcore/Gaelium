...
$(package)_patches=fix_qglobal_includes.patch fix_qendian_includes.patch fix_qbytearraymatcher_includes.patch fix_qt_pkgconfig.patch mac-qmake.conf fix_no_printer.patch no-xlib.patch
...
define $(package)_preprocess_cmds
  patch -p1 -i $($(package)_patch_dir)/fix_qglobal_includes.patch && \
  patch -p1 -i $($(package)_patch_dir)/fix_qendian_includes.patch && \
  patch -p1 -i $($(package)_patch_dir)/fix_qbytearraymatcher_includes.patch && \
